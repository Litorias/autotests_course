...
class Trigon:
    """
    Class:
        Triagon: Класс, представляющий треугольник.
    ...
    Raises:
        TypeError: Если хотя бы одна сторона передана не числом.
        ValueError: Если хотя бы одна сторона передана нулем или отрицательным числом.
        Exception: Если не соблюдается неравенство треугольника.
        IndexError: Если передано не 3 аргумента.
    """
